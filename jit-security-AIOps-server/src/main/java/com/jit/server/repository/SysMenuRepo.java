...
public interface SysMenuRepo extends JpaRepository<SysMenuEntity, String>, JpaSpecificationExecutor<SysMenuEntity> {
     ...
     * @return Object List
     */
    @Query("SELECT u.id,u.path,u.component,u.redirect,u.name,u.title,u.icon,u.isShow FROM SysMenuEntity u WHERE  u.isDeleted = 0 and u.parentId = ?1 order by u.orderNum")
