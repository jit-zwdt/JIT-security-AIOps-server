 ...
 */
public final class CronValidate implements Serializable, Cloneable {
     ...
     */
    public CronValidate(String cronExpression) throws ParseException {
     ...
     */
    public CronValidate(CronValidate expression) {
        /*
    ...
    public static boolean isValidExpression(String cronExpression) {
        ...
        try {
            new CronValidate(cronExpression);
