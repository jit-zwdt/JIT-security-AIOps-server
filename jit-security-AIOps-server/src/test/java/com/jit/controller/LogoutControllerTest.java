...
import com.jit.server.controller.LogoutController;
...
public class LogoutControllerTest {
    ...
    @Before
    public void setUp() {
        mvc = MockMvcBuilders.standaloneSetup(loginController, logoutController).build();
    }
    ...
    public void logoutTest() throws Exception {
        RequestBuilder builder2 = MockMvcRequestBuilders.post("/logout/logout").accept(MediaType.APPLICATION_JSON)
