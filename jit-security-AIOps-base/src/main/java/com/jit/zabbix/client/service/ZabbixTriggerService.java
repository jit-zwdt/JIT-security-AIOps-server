...
public class ZabbixTriggerService {
     ...
     */
    public List<ZabbixTrigger> get(ZabbixGetTriggerParams params, String auth) throws ZabbixApiException {
        ...
        return jsonMapper.getList(response.getResult(), ZabbixTrigger.class);
    }
